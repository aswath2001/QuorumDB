...
mongoose.connect("mongodb+srv://Aswath:"+process.env.MONGO_PASSWORD+"@cluster0.tzobe.mongodb.net/QuorumDB?retryWrites=true&w=majority",{useNewUrlParser:true});
...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "https://quorum-network.herokuapp.com/auth/google/Quorum",
